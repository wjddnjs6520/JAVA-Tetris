...
public class TetrisCanvas extends JPanel implements Runnable, KeyListener {
	...
	public void swappiece() {					
		int type = current1.getType();
		switch(type) {
		case 1:
			tempcurrent = new Z(data);
			break;
		case 2:
			tempcurrent = new S(data);
			break;
		case 3:
			tempcurrent = new Bar(data);
			break;
		case 4:
			tempcurrent = new O(data);
			break;
		case 5:
			tempcurrent = new El(data);
			break;
		case 6:
			tempcurrent = new Tee(data);
			break;
		case 7:
			tempcurrent = new J(data);
			break;
		}
		int x, y;
		x = current1.getX();
